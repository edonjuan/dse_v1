...
EK_TM4C129EXL.obj: ../EK_TM4C129EXL.c $(GEN_OPTS) | $(GEN_HDRS)
	...
	"C:/ti/ccsv7/tools/compiler/ti-cgt-arm_16.9.6.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=FPv4SPD16 -me --include_path="C:/Users/mario.donjuan/workspace_v7/mailbox2" --include_path="C:/Users/mario.donjuan/workspace_v7/mailbox2" --include_path="C:/ti/tirtos_tivac_2_16_01_14/products/TivaWare_C_Series-2.1.1.71b" --include_path="C:/ti/tirtos_tivac_2_16_01_14/products/bios_6_45_02_31/packages/ti/sysbios/posix" --include_path="C:/ti/ccsv7/tools/compiler/ti-cgt-arm_16.9.6.LTS/include" --define=ccs="ccs" --define=PART_TM4C129ENCPDT --define=ccs --define=TIVAWARE -g --gcc --diag_warning=225 --diag_warning=255 --diag_wrap=off --display_error_number --gen_func_subsections=on --abi=eabi --preproc_with_compile --preproc_dependency="EK_TM4C129EXL.d_raw" $(GEN_OPTS__FLAG) "$<"
...
build-1490423329:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1490423329-inproc

build-1490423329-inproc: ../empty.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1490423329 ../empty.cfg
configPkg/compiler.opt: build-1490423329
configPkg/: build-1490423329
