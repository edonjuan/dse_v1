...
.dlls,em4f .dlls: dse_Hwi.pem4f

-include package/cfg/dse_Hwi_pem4f.mak
-include package/cfg/dse_Hwi_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/dse_Hwi_pem4f.dep
endif
dse_Hwi.pem4f: package/cfg/dse_Hwi_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
dse_Hwi.pem4f package/cfg/dse_Hwi_pem4f.c: .libraries,em4f
endif

package/cfg/dse_Hwi_pem4f.c package/cfg/dse_Hwi_pem4f.h package/cfg/dse_Hwi_pem4f.xdl: override _PROG_NAME := dse_Hwi.xem4f
package/cfg/dse_Hwi_pem4f.c: package/cfg/dse_Hwi_pem4f.cfg
package/cfg/dse_Hwi_pem4f.xdc.inc: package/cfg/dse_Hwi_pem4f.xdl
package/cfg/dse_Hwi_pem4f.xdl package/cfg/dse_Hwi_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/dse_Hwi_pem4f.cfg
	-$(RM) package/cfg/dse_Hwi_pem4f.dep
	-$(RM) package/cfg/dse_Hwi_pem4f.c
	-$(RM) package/cfg/dse_Hwi_pem4f.xdc.inc

clean,em4f::
	-$(RM) dse_Hwi.pem4f
.executables,em4f .executables: dse_Hwi.xem4f

dse_Hwi.xem4f: |dse_Hwi.pem4f

-include package/cfg/dse_Hwi.xem4f.mak
dse_Hwi.xem4f: package/cfg/dse_Hwi_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/dse_Hwi_pem4f.oem4f   package/cfg/dse_Hwi_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
dse_Hwi.xem4f: export C_DIR=
dse_Hwi.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
dse_Hwi.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

dse_Hwi.test test,em4f test: dse_Hwi.xem4f.test

dse_Hwi.xem4f.test:: dse_Hwi.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 dse_Hwi.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.dse_Hwi.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,dse_Hwi.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
dse_Hwi_pem4f.oem4f,copy : package/cfg/dse_Hwi_pem4f.oem4f
dse_Hwi_pem4f.sem4f,copy : package/cfg/dse_Hwi_pem4f.sem4f
