...
.dlls,em4f .dlls: dse_Semaphore.pem4f

-include package/cfg/dse_Semaphore_pem4f.mak
-include package/cfg/dse_Semaphore_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/dse_Semaphore_pem4f.dep
endif
dse_Semaphore.pem4f: package/cfg/dse_Semaphore_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
dse_Semaphore.pem4f package/cfg/dse_Semaphore_pem4f.c: .libraries,em4f
endif

package/cfg/dse_Semaphore_pem4f.c package/cfg/dse_Semaphore_pem4f.h package/cfg/dse_Semaphore_pem4f.xdl: override _PROG_NAME := dse_Semaphore.xem4f
package/cfg/dse_Semaphore_pem4f.c: package/cfg/dse_Semaphore_pem4f.cfg
package/cfg/dse_Semaphore_pem4f.xdc.inc: package/cfg/dse_Semaphore_pem4f.xdl
package/cfg/dse_Semaphore_pem4f.xdl package/cfg/dse_Semaphore_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/dse_Semaphore_pem4f.cfg
	-$(RM) package/cfg/dse_Semaphore_pem4f.dep
	-$(RM) package/cfg/dse_Semaphore_pem4f.c
	-$(RM) package/cfg/dse_Semaphore_pem4f.xdc.inc

clean,em4f::
	-$(RM) dse_Semaphore.pem4f
.executables,em4f .executables: dse_Semaphore.xem4f

dse_Semaphore.xem4f: |dse_Semaphore.pem4f

-include package/cfg/dse_Semaphore.xem4f.mak
dse_Semaphore.xem4f: package/cfg/dse_Semaphore_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/dse_Semaphore_pem4f.oem4f   package/cfg/dse_Semaphore_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
dse_Semaphore.xem4f: export C_DIR=
dse_Semaphore.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
dse_Semaphore.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

dse_Semaphore.test test,em4f test: dse_Semaphore.xem4f.test

dse_Semaphore.xem4f.test:: dse_Semaphore.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 dse_Semaphore.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.dse_Semaphore.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,dse_Semaphore.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) dse_Semaphore.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
dse_Semaphore_pem4f.oem4f,copy : package/cfg/dse_Semaphore_pem4f.oem4f
dse_Semaphore_pem4f.sem4f,copy : package/cfg/dse_Semaphore_pem4f.sem4f
